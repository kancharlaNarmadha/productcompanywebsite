        ...
        <div class="home">
            <div class="header">
                ...
                <center></centre>
                    ...
                    <img src="/static/images/product2.jpg">
                    <img src="/static/images/product3.jpg">
                    <img src="/static/images/product4.jpg">
                    <img src="/static/images/product5.jpg">
                    <img src="/static/images/product6.jpg">
                    <img src="/static/images/product7.jpg">
                </center>
                </div>
                <div class="footer">
                <footer style="color:black">
               Copyright &copy;2023 Developed by NAVEEN M</footer></div>
            </div>
        </div>
    </body>
</html>
...
<html lang="en">
    <head>
        ...
        .ph2{
            background-image: url(/static/images/product2.jpg);
      ...
      .ph3{
            background-image: url(/static/images/product3.jpg);
        ...
        .ph4{
            background-image: url(/static/images/product4.jpg);
            background-position-x: center;
            border:1px solid white;
            height:200px;
            width:30%;
        ...
        .ph5{
            background-image: url(/static/images/product5.jpg);
            background-position-x: center;
            border:1px solid white;
            height:200px;
            width:30%;
        ...
        .ph6{
            background-image: url(/static/images/product6.jpg);
            background-position-x: center;
            border:1px solid white;
            height:200px;
            width:30%;
...
<html lang="en">
    <head>
        ...
        .ceoph{
            background-image: url(/static/images/member1.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
        ...
        .amph1{
            background-image: url(/static/images/member4.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph2{
            background-image: url(/static/images/member5.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph3{
            background-image: url(/static/images/member6.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
...
![WEB OUT 7 1](https://github.com/kancharlaNarmadha/productcompanywebsite/assets/119559316/f906b805-9224-410f-b7d7-e67eb3c71a67)


### Home Page:

![WEB OUT 7 2](https://github.com/kancharlaNarmadha/productcompanywebsite/assets/119559316/9aa7fd7b-b674-499f-bc0a-1827faab6da9)

# Products Page:


![WEB OUT 7 3](https ://github.com/kancharlaNarmadha/productcompanywebsite/assets/119559316/fe1563cf-fa2a-46a9-886f-b6005c20a553)

# People Page:


![WEB OUT 7 4](https://github.com/kancharlaNarmadha/productcompanywebsite/assets/119559316/ea4dd22e-228f-4953-b993-8cc1e8038095)

# Contact Page:

![WEB OUT 7 5](https://github.com/kancharlaNarmadha/productcompanywebsite/assets/119559316/b9c0133c-e985-43be-8a8a-4b9cd1db28ae)
